!(function () {
  if (
    ...
    if ((a = a[a.length - 1]).hasAttribute('data-autoloader-path')) {
      ...
      /[\w-]+\.js$/.test(a.src) &&
        (e = a.src.replace(/[\w-]+\.js$/, 'components/'));
    var p = (Prism.plugins.autoloader = {
        ...
        var a = function () {
            ...
            if (
              ...
              c &&
                ...
                a.success_callbacks.push(c)),
              s &&
                (a.error_callbacks || (a.error_callbacks = []),
                a.error_callbacks.push(s)),
              !t && Prism.languages[e])
            )
              m(e);
            else if (!t && a.error) k(e);
            else if (t || !a.loading) {
              (a.loading = !0),
                (function (a, e, c) {
      ...
      m = function (e) {
        n[e] &&
          n[e].success_callbacks &&
          n[e].success_callbacks.length &&
          n[e].success_callbacks.forEach(function (a) {
            a(e);
          });
      },
      k = function (e) {
        n[e] &&
          n[e].error_callbacks &&
          n[e].error_callbacks.length &&
          n[e].error_callbacks.forEach(function (a) {
            a(e);
          });
      };
    Prism.hooks.add('complete', function (a) {
      a.element &&
        ...
        (function (a, e) {
          ...
          !s &&
            e.parentNode &&
            'pre' === e.parentNode.tagName.toLowerCase() &&
            (s = e.parentNode.getAttribute('data-dependencies')),
            (s = s ? s.split(/\s*,\s*/g) : []),
            o(s, function () {
              u(a, function () {

...
!(function (e) {
  ...
  (function (e, t) {
    ...
    return (function (e) {
            ...
            if (
              ...
              if (
                ...
                l.theme &&
                  ...
                  (n.theme = T(n.instanceOptions.themes[l.theme], null)),
                  ...
                  if (c > 1) {
                    ...
                    for (var y = 0; y < d.length; y++)
                      if (0 !== d[y].length) {
                        ...
                        var S = t.getBBox();
                        v.push({ text: d[y], width: S.width });
                      }
                  }
                  return (
                    (e.style.display = 'none'),
                    { spaceWidth: m, lineCount: c, boundingBox: u, words: v }
                  );
                }
                return !1;
              };
            })();
          for (var M in O.flags)
            O.flags.hasOwnProperty(M) &&
              (O.flags[M].match = function (e) {
            ...
            (function () {
              ...
              e.getContext &&
                ...
                document.createElementNS &&
                  document.createElementNS(F, 'svg').createSVGRect &&
      ...
      function (e, t) {
        e.exports = { version: '2.9.6', svg_ns: 'http://www.w3.org/2000/svg' };
      },
      function (e, t, n) {
        function r(e, t) {
          return c.element({

    ...
    at = (function () {
      ...
      return (
        ...
        (t._getItemIndex = function (t) {
          return (
            (this._items = t && t.parentNode ? [].slice.call(t.parentNode.querySelectorAll(tt)) : []), this._items.indexOf(t)
          );
        }),
        ...
        keepTogether: {
          ...
          fn: function (t) {
            var e = t.offsets,
              ...
              c = s ? 'width' : 'height';
            return (
              n[a] < r(i[l]) && (t.offsets.popper[l] = r(i[l]) - n[c]), n[l] > r(i[a]) && (t.offsets.popper[l] = r(i[a])), t
            );
          },
        },
        arrow: {
    ...
    Ci = (function () {
      function n(t, e) {
        ...
        (this._element = t),
          ...
          (this._config = this._getConfig(e)),
          (this._selector =
            this._config.target + ' ' + mi + ',' + this._config.target + ' ' + _i + ',' + this._config.target + ' ' + yi),
          (this._offsets = []),
          (this._targets = []),
